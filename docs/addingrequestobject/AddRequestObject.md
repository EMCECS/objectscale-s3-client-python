...
In order to add a request object for our new method we have to define a new shpae under the the shapes section of the dictionary. 

After adding said shape, we have to add the shape to our new api call by using the "input" field. 
